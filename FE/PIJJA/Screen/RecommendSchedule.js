...
import { SafeAreaView, View, SectionList, Text, StyleSheet, TouchableOpacity } from "react-native";
...
const Item = ({ id,title,address,navigation }) => (
    <View style={{
        ...
        <View style={styles.stick} />
        <Icon name="pluscircleo" size={30} color="#000000" onPress={ () => console.log("추천해주세요")} />
    </View>
);
    ...
    return (
        ...
        >
            <SectionList
                ...
                renderItem={({ item }) => <Item id={item.id} title={item.title} address={item.address} />}
