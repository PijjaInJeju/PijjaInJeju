...
const Data = {
    "placeList":[
        ...
        {"id":10,"name":"이음새농촌교육농장","latitude":33.2762,"longitude":126.651}
    ],
                ...
                >
                    ...
                    
                    {
                        Data.placeList.map( (coordinate)=>{
                            console.log(coordinate);
                            return (
                                <Marker coordinate={coordinate} pinColor="blue" onClick={() => console.warn('coordinate' , coordinate.name)} />
                            );
                        }
                    )
                    }
                    ...
                    <Path coordinates={Data.pathList} onClick={() => console.warn('onClick! path')} color={"rgba(255,0,0,0.3)"} width={4}/>
                        ...
                        <TextInput
                            ...
                            onChangeText={
                                (keyword) =>{
                                    console.log(keyword);
                                    setSearch(keyword);
                                    Rest("/api/places/serachPlace","POST",
                                        {
                                            title: keyword,
                                        },
                                        (res) => {
